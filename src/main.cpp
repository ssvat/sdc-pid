...
int main()
{
  ...
  double Kp_= 0.2;  //control parameter, the bigger the more oscillation
  double Ki_ = 0.00;  //control parameter, systematic bias
  double Kd_ = 3.0;   //differential control parameter, without this causing a big CTE
